...
public class PNGStatusObject implements StatusObject {
	...
	public PNGStatusObject(String filename, VoronoiTreemap treemap, ArrayList<String> names, ArrayList<Integer> weights){
	...
	public void finished() {
		...
		renderer.renderTreemap(null,this.names, this.weights);
